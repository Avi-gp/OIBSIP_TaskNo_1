# Name:- Gupta Suryansh Jayprakadsh
...
print('Loading your AI personal assistant - SpeakSage')
...
speak("Loading your AI personal assistant SpeakSage ")
wishMe()
...
if __name__=='__main__':
    ...
    while True:
        ...
        if 'wikipedia' in statement:
            ...
            speak('I am SpeakSage version 1 point O your persoanl assistant. I am programmed to minor tasks like'
                  'opening youtube,google chrome,gmail and stackoverflow ,predict time,take a photo,search wikipedia,predict weather' 
                  'in different cities , get top headline news from times of india and you can ask me computational or geographical questions too!')


        elif "who made you" in statement or "who created you" in statement or "who discovered you" in statement:
            speak("I was built by Suryansh")
            print("I was built by Suryansh")
